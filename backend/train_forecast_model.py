...
from data.generate_historical_data import generate_historical_tickets, save_historical_data, load_historical_data, get_data_summary
import os
...
def train_forecasting_model():
    ...
    for pred in daily_preds:
        ...
        print(f"   {pred['date']}: {pred['predicted_tickets']} tickets → {staffing['recommended_agents']} agents {staffing['message']}")
