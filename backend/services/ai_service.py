...
Uses OpenRouter API for fast LLM inference
"""
...
class TicketAIService:
    ...
    def generate_suggested_reply(
        self, ticket_data: Dict[str, Any], kb_context: str = None
    ) -> str:
        """
        ...
        if not self.client:
            return (
                "AI reply generation is currently unavailable. Please respond manually."
            )
...
def classify_ticket(
    subject: str, description: str, metadata: Dict[str, Any] = None
) -> Dict[str, Any]:
    """
