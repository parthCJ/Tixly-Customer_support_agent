    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-center">
          <div className="animate-spin rounded-full h-10 sm:h-12 w-10 sm:w-12 border-b-2 border-primary-600 mx-auto"></div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">Total Agents</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mt-1">
                {totalAgents}
              </p>
              <p className="text-[10px] sm:text-xs text-gray-500 mt-1">{activeAgents} active</p>
            </div>
            <div className="h-10 w-10 sm:h-12 sm:w-12 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center">
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">Active Tickets</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mt-1">
                {totalLoad}
              </p>
              <p className="text-[10px] sm:text-xs text-gray-500 mt-1">of {totalCapacity} capacity</p>
            </div>
            <div className="h-10 w-10 sm:h-12 sm:w-12 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center">
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">Team Utilization</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mt-1">
                {avgUtilization.toFixed(0)}%
              </p>
              <p className="text-[10px] sm:text-xs text-gray-500 mt-1">Average across team</p>
            </div>
            <div className="h-10 w-10 sm:h-12 sm:w-12 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center">
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">Recommended Staff</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mt-1">
      ...
      {staffing && (
        <div className={`mb-6 sm:mb-8 p-3 sm:p-4 rounded-lg ${
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div>
              <p className="text-sm sm:text-base font-medium text-gray-900 dark:text-white">{staffing.message}</p>
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1">
                Based on {staffing.predicted_tickets} predicted tickets ({staffing.tickets_per_agent} tickets/agent)
              </p>
            </div>
            <Button variant="primary" size="sm" className="w-full sm:w-auto whitespace-nowrap">Schedule Agents</Button>
          </div>
        </div>
      )}
              ...
              <div key={agent.agent_id} className="flex items-center justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    <p className="text-sm sm:text-base font-medium text-gray-900 dark:text-white">{agent.name}</p>
