...
class KnowledgeBaseSearchTool(BaseTool):
    ...
    def _run(self, query: str, top_k: int = 3) -> str:
        ...
        try:
            ...
            results = self.kb_service.search_knowledge_base(query=query, top_k=top_k)
...
class TicketCategoryValidatorTool(BaseTool):
    ...
    VALID_CATEGORIES = [
        "SHIPPING", "BILLING", "TECHNICAL", "PRODUCT", 
        "ACCOUNT", "REFUND", "GENERAL"
    ]
...
class UrgencyKeywordDetectorTool(BaseTool):
    ...
    URGENCY_KEYWORDS = [
        ...
        "frustrated", "angry", "unacceptable", "disappointed",
        "losing money", "business impact", "deadline", "needed yesterday"
    ]
